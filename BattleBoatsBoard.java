...
public class BattleBoatsBoard {
    ...
    public int[] numHit; // Used to track the hit times of each boat
    ...
    public void setNumHit(int numBoat){
        ...
        if (numBoat == 8){
            boardCollection = new int[8];
            boardCollection = new int[]{2, 3, 3, 4, 5,6,7,5};
        } if (numBoat == 10){
     ...
     */
    public void missile(int xCor, int yCor, grid[][] a) {
